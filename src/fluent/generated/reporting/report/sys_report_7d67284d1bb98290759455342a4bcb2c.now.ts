...
Record({
    $id: Now.ID['7d67284d1bb98290759455342a4bcb2c'],
    table: 'sys_report',
    data: {
        active: false,
        aggregate: 'COUNT',
        ...
        field: 'identity',
        field_list: ['number', 'valid_from', 'valid_to', 'provisioning_action', 'provisioning_status'],
        filter: 'asset.type.code=PERMANENT_BADGE^status=2a7f0ed51bbc8210759455342a4bcbe9^ORstatus=627f0ed51bbc8210759455342a4bcbeb',
        ...
        title: 'Cardholder With Active Badges',
