...
Record({
    $id: Now.ID['c65400701bb94290759455342a4bcb1f'],
    table: 'sys_report',
    data: {
        active: false,
        additional_groupby: 'acl_criticality',
        aggregate: 'COUNT',
        ...
        chart_title: 'Access Levels without Owners',
        ...
        field: 'acl_system',
        field_list: ['acl_name', 'acl_system', 'ao_type', 'acl_criticality'],
        filter: 'ao_ownerISEMPTY',
        ...
        title: 'Access Levels without Owners',
        title_horizontal_alignment: 'left',
