...
Record({
    $id: Now.ID['d5ab20c11bf98290759455342a4bcb06'],
    table: 'sys_report',
    data: {
        active: false,
        aggregate: 'COUNT',
        ...
        field: 'request',
        field_list: ['request', 'provisioning_action', 'provisioning_status'],
        filter: 'provisioning_status=0d8fced51bbc8210759455342a4bcb45^ORprovisioning_status=418fced51bbc8210759455342a4bcb47^ORprovisioning_status=cd8fced51bbc8210759455342a4bcb47',
        ...
        others: 'true',
        pivot_expanded: true,
        roles: ['x_aleen_snguardian.employee', 'x_aleen_snguardian.lobby_admin'],
        ...
        title: 'Request with Provisioning Errors',
