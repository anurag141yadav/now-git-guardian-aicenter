...
Record({
    $id: Now.ID['f25c72621b314a90759455342a4bcbc6'],
            ...
            "composition": [
                {
                    ...
                    "propertyValues": {
                        ...
                        "activeRoute": {
                            ...
                            "order": 0,
                            "type": "local",
                            "routeType": "cl1kajg2y015e3f71kyb7f5qr"
                        }
                    },
                    "eventMappings": [
                        {
                        ...
                        "composition": [
                            {
                                ...
                                "slot": "cl1kajg2y015e3f71kyb7f5qr",
                                "definition": {
                                    "type": "MACROPONENT",
                            ...
                            },
                            {
                                ...
                                "slot": "cl1kali8f01683f712up7uv9s",
                                "definition": {
                                    "type": "REPEATER",
                                    "id": ""
                                },
                                    ...
                                    "composition": [
                                        {
                                            ...
                                            "eventMappings": [
                                                {
                                                    "eventMappingId": "cljjylymjjpaaeeveddbhhvmhibbcxrdd",
                                                    "isConfiguration": false,
                                                    "offRowStorageId": null,
                                                    ...
                                                    "targets": [
                                                        {
                                                            ...
                                                            "operation": {
                                                                "dataBrokerId": "029f04e053610110ac9bddeeff7b1294",
                                                                "operationName": "CTRL_RECORD#ADD_NOTIFICATION",
                                                                "parentResourceId": "record",
                                                                "payload": {
                                                                    "type": "MAP_CONTAINER",
                                                                    "container": {
                                                            ...
                                                            "targetId": "clduvtjjmffaacchgddbhhvaaiukilob",
                                                            "type": "DATABROKER_OP"
                                                        }
                                                    ]
                                                },
                                                {
                                                    "eventMappingId": "clccsjjjpaayaaffnzddghhgfdbbhhtaggt",
                                                    "isConfiguration": false,
                                                    "offRowStorageId": null,
                                                    "sourceEventApiName": "sn_record_list_con.NOW_RECORD_LIST_CONNECTED#PREVIEW_RECORD",
                                                    "sourceEventCorrelationId": null,
                                                    "sourceEventDefinition": {
                                                        "apiName": "sn_record_list_con.NOW_RECORD_LIST_CONNECTED#PREVIEW_RECORD",
                                                        "id": null,
                                                        "type": "UXEVENT"
                                                    },
                                                    "sourceEventSysId": null,
                                                    "targets": [
                                                        {
                                                            ...
                                                            "targetId": "clccsjjjpaayaaffoaaddghhgcfxhhevz",
                                                            "type": "DATABROKER_OP"
                                                        }
                                                    ]
                                                }
                            ...
                            },
                            {
                                ...
                                "slot": "cldkt66wk02g93b7vaejgm12q",
                                "definition": {
                                    "type": "MACROPONENT",
                                    "id": "d356d14b6e293a3020a244b63d278d8f"
                                },
                    ...
                    "propertyValues": {
                        ...
                        "initiallyCollapsed": {
                            ...
                            "script": {
                                ...
                                "inlineScript": null,
                                "scriptSysId": "eb53011eb7d41110f7f62f19ce11a980",
                                "target": null
                            }
                        },
                        "hideLabel": {
                        ...
                        "activeRoute": {
                            ...
                            "order": 100,
                            "type": "local",
                            "routeType": "cl1kankhk01893f71opig588d"
                        }
                    },
                    "eventMappings": [
                        {
                                ...
                                "overrides": {
                                    "layout": {
                                        "default": {
                                            ...
                                            "rules": null,
                                            "styles": {
                                                "padding": "calc(var(--now-scale-space--xl, 1) * var(--now-static-space--xl))",
                                                "overflow": "auto",
        ...
        "overrides": {
            "layout": {
                "default": {
                    ...
                    "rules": null,
                    "styles": {
                        "padding": "calc(var(--now-scale-space--xl, 1)*24px) calc(var(--now-scale-space--xl, 1)*24px) calc(var(--now-scale-space--md, 1)*12px)"
                    },
                    "templateId": "5832fd4d53c31010e6bcddeeff7b12db",
                    "type": "flex"
                },
                    ...
                    "overrides": {
                        ...
                        "composition": [
                            ...
                            },
                            {
                                ...
                                "eventMappings": [
                                    {
                                        "eventMappingId": "clvkxrmfbaaddddaaddffhhruddpccbamf",
                                        "isConfiguration": false,
                                        "offRowStorageId": null,
                                        ...
                                        "targets": [
                                            {
                                                "targetId": "clvkxrmfcaaddddbbddffhhrqksmiijjqii",
                                                "type": "EVENT",
                                                "declarativeAction": null,
                                                "event": {
                                                    "sysId": "066c7e221b314a90759455342a4bcb35",
                                                    "payload": {
                                                        "type": "JSON_LITERAL",
                                                        "value": {
                        ...
                        "composition": [
                            {
                                ...
                                "propertyValues": {
                                    "src": {
                                        "type": "JSON_LITERAL",
                                        "value": "/x_aleen_snguardian.badge.png"
                                    },
                                    "sources": {
                                        "type": "JSON_LITERAL",
                                        "value": [
    ...
    },
    {
        ...
        "inputValues": {
            "table": {
                "type": "JSON_LITERAL",
                "value": "x_aleen_snguardian_identity_asset"
            },
            "recordId": {
                "type": "CONTEXT_BINDING",
                "binding": {
            ...
            "returnFields": {
                "type": "JSON_LITERAL",
                "value": "identity.photo,asset.code,identity.master_user_id"
            },
            "returnTableMetadata": {
                "type": "JSON_LITERAL",
                "value": false
    ...
    },
    {
        ...
        "inputValues": {
            "table": {
                "type": "JSON_LITERAL",
                "value": "x_aleen_snguardian_identity"
            },
            "recordId": {
                "type": "DATA_OUTPUT_BINDING",
                "binding": {
        ...
        dispatched_events: '066c7e221b314a90759455342a4bcb35',
