...
Record({
    $id: Now.ID['1ebd849f2b295210d4dffd74ce91bf44'],
    ...
    data: {
        ...
        name: 'visit_checkout_success_message',
        not_available_conversation: 'false',
        price_if_checked: '0',
        pricing_implications: 'false',
        question_text: 'Visit Checkout Success Message',
        read_only: 'false',
        rec_price_if_checked: '0',
        record_producer_table: 'x_aleen_snguardian_visitor_request',
