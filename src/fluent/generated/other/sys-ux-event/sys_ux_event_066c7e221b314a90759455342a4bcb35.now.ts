...
Record({
    $id: Now.ID['066c7e221b314a90759455342a4bcb35'],
    table: 'sys_ux_event',
    data: {
        event_name: 'MODAL_SELECTED_RELAY_f25c72621b314a90759455342a4bcbc6',
        label: 'Open or close modal dialog Relay (Identity Asset)',
        props: `[
    {
        "defaultValue": null,
