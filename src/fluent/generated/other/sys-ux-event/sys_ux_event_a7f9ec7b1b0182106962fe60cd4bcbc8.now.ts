...
Record({
    $id: Now.ID['a7f9ec7b1b0182106962fe60cd4bcbc8'],
    table: 'sys_ux_event',
    data: {
        event_name: 'MODAL_SELECTED_RELAY_a0345a1c1b688e106962fe60cd4bcbac',
        label: 'Open or close modal dialog Relay (System Record Page)',
        props: `[
    {
        "defaultValue": null,
