...
Record({
    $id: Now.ID['2be6af6e1bb14a90759455342a4bcb92'],
    table: 'sys_ux_event',
    data: {
        event_name: 'MODAL_SELECTED_RELAY_ffd663ae1bb14a90759455342a4bcbd6',
        label: 'Open or close modal dialog Relay (Identity Asset Page)',
        props: `[
    {
        "defaultValue": null,
