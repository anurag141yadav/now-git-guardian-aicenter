...
Record({
    $id: Now.ID['dd2afd921b214a50759455342a4bcb8a'],
    table: 'sys_ux_screen',
    data: {
        active: true,
        ...
        macroponent: 'd12afd921b214a50759455342a4bcb3c',
        macroponent_config: `{
    "bare": {
        "type": "JSON_LITERAL",
        "value": true
    ...
    "scrollable": {
        ...
        screen_condition: 'table=x_aleen_snguardian_access_review_frequency',
