...
Record({
    $id: Now.ID['ff1ad7b333d55a10bf1221382e5c7b06'],
	...
	return '';  // return the calculated value
        ...
        column_label: 'show_welcome_message',
        comments: 'Show Welcome Message',
        display: 'false',
        dynamic_creation: 'false',
        element: 'u_show_welcome_message',
        element_reference: 'false',
        function_field: 'false',
        internal_type: 'boolean',
        label: 'show_welcome_message',
        mandatory: 'false',
        max_length: '40',
